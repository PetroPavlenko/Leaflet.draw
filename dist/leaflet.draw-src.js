/*
 Leaflet.draw 0.4.9+23439d8, a plugin that adds drawing and editing tools to Leaflet powered maps.
...
L.EditToolbar = L.Toolbar.extend({
  ...
  getActions: function() {
    ...
    if (typeof this.options.actions === 'object') {
      var that = this;
      Object.keys(this.options.actions).forEach(function(name) {
        if (!that.options.actions[name]) {
          delete actions[name];
        }
      });
    }
